...
#
# Purpose of this file : Process the rand prepare it for object detection
#
...
def show_pcl(pcl, frame_ind):
    ...
    Obj_3D_View = o3d.visualization.VisualizerWithKeyCallback()
    Obj_3D_View.create_window(windowname="Visual Point Cloud", visible=True)
    ...
    if frame_ind == 0:
        Obj_3D_View.add_geometry(pcd)
    else:
        Obj_3D_View.update_geometry(pcd)
    
    # step 5 : visualize point cloud and keep window open until right-arrow is pressed (key-code 262)

    # Keep window open
    def Close_Window(Obj_3D_View):
        Obj_3D_View.close()
        return False
    
    o3d.visualization.draw_geometries([pcd])
    Obj_3D_View.register_key_callback(262,Close_Window)
    Obj_3D_View.run()
    Obj_3D_View.destroy_window()
